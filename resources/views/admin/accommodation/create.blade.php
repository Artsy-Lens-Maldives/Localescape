                  ...
                  <div class="row">
                     ...
                     <div class="row" style="display: block;">
                        <div class="col-md-12">
                           ...
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="form-group" style="display: block;">
                                    <label class="control-label control-label-left col-sm-3">Special Offer</label>
                                    <div class="controls col-sm-9">
                                       <label class="checkbox" for="special_offer"><input type="checkbox" value="" id="special_offer" name="field20" data-parsley-errors-container="#errId4"></label><span id="errId4" class="error"></span>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="control-label control-label-left col-sm-3 sr-only" for="field27"></label>
                                    <div class="controls col-sm-9">
                                       <input id="field27" type="text" class="form-control k-textbox" data-role="text" placeholder="20%" name="percents" data-parsley-errors-container="#errId5"><span id="errId5" class="error"></span>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="control-label control-label-left col-sm-3 sr-only" for="field28"></label>
                                    <div class="controls col-sm-9">
                                       <input id="field28" type="text" class="form-control k-textbox" data-role="text" placeholder="Off the Price Today" name="special-offer-text" data-parsley-errors-container="#errId6"><span id="errId6" class="error"></span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              <label class="control-label control-label-left col-sm-3">Recieve Special Offers</label>
                              <div class="controls col-sm-9">
                                 <label class="checkbox" for="receive_reviews"><input type="checkbox" value="1" id="receive_reviews" name="field41" data-parsley-errors-container="#errId8"></label><span id="errId8" class="error"></span>
                              </div>
                           </div>
                           <div class="form-group" style="display: block;">
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group" style="display: block;">
                                    ...
                                    <div class="controls col-sm-9">
                                       <label class="checkbox" for="checkbox70"><input type="checkbox" value="1" id="checkbox70" name="field67" data-parsley-errors-container="#errId25"></label><span id="errId25" class="error"></span>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="controls col-sm-9">
                                       <label class="checkbox" for="checkbox75"><input type="checkbox" value="1" id="checkbox75" name="field72" data-parsley-errors-container="#errId26"></label><span id="errId26" class="error"></span>
                                    </div>
                                 </div>
                              </div>
                           </div>
