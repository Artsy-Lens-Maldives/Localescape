...
You have confirmed the booking cancellation request on booking at {{ $booking->room->accommodation->title }} - {{ $booking->room->room_type }} on  {{ $booking->created_at->toFormattedDateString() }} was confirmed by {{ $booking->room->accommodation->title }} .You will see the booking details below 
