    ...
    <div class="container">
        ...
        <div class="main-content">
                ...
                <div class="panel-body">
                    ...
                    <section id="gallery">
                        <form action="{{ url()->current() }}/new" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="">
                                <input id="input-b2" name="image[]" type="file" multiple accept="gif|jpg|png" required>
                            </div>
                        <section>
                            <br>
            ...
            @if($acco->rooms->isempty() )
                <h4>No Rooms found for this Accommodation <a href="{{ url('extranet/accommodations/rooms') }}/{{ $acco->id }}" class="btn btn-lg btn-warning">Add a room</a> </h4>
            @else
                        ...
                        @foreach($acco->rooms as $room)
                            <div class="row">
                                @if($room->photos->count() < 4)
                                    <div class="col-md-12">
                                        <div class="alert alert-info">Try adding atleast 4 photos to your room, Now added {{ $room->photos->count() }} of 4 Photos</div>
                                    </div>
                                @endif
                            </div>
                            <div>
