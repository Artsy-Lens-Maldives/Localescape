...
<html lang="en">
  <head>
    ...
    <title>LocalEscape | Photo Package Panel</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('photopackage/home') }}" class="site_title"><i class="fa fa-paw"></i> <span>Photo Package Panel</span></a>
            </div>
            ...
            @include('partials.photo-sidebar')
          </div>
        </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                        <a href="{{ url('/photopackage/logout') }}"
                            onclick="event.preventDefault();
                                      document.getElementById('logout-form').submit();">
                            Logout
                        </a>

                        <form id="logout-form" action="{{ url('/photopackage/logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
                    </li>
                  </ul>
        ...
        <footer>
          <div class="pull-right">
            Local Escape Photo Package Panel by Artsy Lens Maldives
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
