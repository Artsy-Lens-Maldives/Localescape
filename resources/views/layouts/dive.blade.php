...
<html lang="en">
  <head>
    ...
    <title>LocalEscape | Dive Package Panel</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('divepackage/home') }}" class="site_title"><i class="fa fa-paw"></i> <span>Dive Package Panel</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                      <a href="{{ url('divepackage/logout') }}"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </li>
                  </ul>
                </li>
              </ul>
        ...
        <footer>
          <div class="pull-right">
            Local Escape Dive Package Panel by Artsy Lens Maldives
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
